                ...
                (t = [{
                        ...
                        value: function(e) {
                            null == e && (e = {}),
                                (this.options = {
                                    ...
                                    disabledWeekDays: e.disabledWeekDays instanceof Array ?
                                        e.disabledWeekDays : [],
                                    ...
                                    dataSource: e.dataSource instanceof Array ||
                                    ...
                                    contextMenuItems: e.contextMenuItems instanceof Array ?
                                        e.contextMenuItems : [],
                                    customDayRenderer: "function" == typeof e.customDayRenderer ?
                                        e.customDayRenderer : null,
                                    customDataSourceRenderer: "function" == typeof e.customDataSourceRenderer ?
                                        e.customDataSourceRenderer : null,
                                    weekStart: isNaN(parseInt(e.weekStart)) ?
                                        null : parseInt(e.weekStart),
                                    loadingTemplate: "string" == typeof e.loadingTemplate ||
                                        e.loadingTemplate instanceof HTMLElement ?
                                        e.loadingTemplate : null,
                                }),
                        ...
                        value: function() {
                            for (
                                var e =
                                    0 < arguments.length &&
                                    void 0 !== arguments[0] &&
                                    arguments[0]; this.element.firstChild;
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            for (
                                var t = new Date(this._startDate.getTime()), n = 0; n < this.options.numberMonthsDisplayed; n++
                            ) {
                                ...
                                for (
                                    var h = new Date(t.getTime()),
                                        p = new Date(t.getFullYear(), t.getMonth() + 1, 0); h.getDay() != d;
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            for (
                                var a = this._getDate(e), i = this.getEvents(a), s = 0; s < i.length; s++
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            return (
                                ...
                                t.setTime(t.getTime() - 1), { startDate: e, endDate: t }
                            );
                        },
                    },
                    {
